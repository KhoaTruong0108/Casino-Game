...
public class GetListLevelRequest extends casino.cardgame.message.request.SFSGameRequest {
    ...
    public SFSGameRequest FromSFSObject(ISFSObject isfso) {
        _levelType = isfso.getDouble("level_type").intValue();
    ...
    public String GetRequestName() {
        return ADMIN_REQUEST_NAME.GET_LIST_LEVEL_REQ;
    }
