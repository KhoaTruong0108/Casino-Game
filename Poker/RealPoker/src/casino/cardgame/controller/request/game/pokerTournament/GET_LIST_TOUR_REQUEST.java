...
import casino.cardgame.message.request.game.pokerTournament.GetListTourRequest;
 ...
 */
public class GET_LIST_TOUR_REQUEST extends BaseClientRequestHandler{

    @Override
    public void handleClientRequest(User user, ISFSObject isfso) {
        try{
            //khoatd
            GetListTourRequest request = new GetListTourRequest();
