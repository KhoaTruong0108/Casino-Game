...
import casino.cardgame.message.request.game.pokerTournament.GetDetailTourRequest;
 ...
 */
public class GET_DETAIL_TOUR_REQUEST extends BaseClientRequestHandler{

    @Override
    public void handleClientRequest(User user, ISFSObject isfso) {
        try{
            //khoatd
            GetDetailTourRequest request = new GetDetailTourRequest();
