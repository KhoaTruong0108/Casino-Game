...
import casino.cardgame.message.request.game.poker.GoingAllInRequest;
 ...
 */
public class GOING_ALL_IN_REQUEST extends BaseClientRequestHandler{

    @Override
    public void handleClientRequest(User user, ISFSObject isfso) {
        try{
            //khoatd
            GoingAllInRequest request = new GoingAllInRequest();
