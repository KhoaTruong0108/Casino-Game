...
import casino.cardgame.message.request.admin.DeleteLevelRequest;
 ...
 */
public class DELETE_LEVEL_REQUEST extends BaseClientRequestHandler{

    @Override
    public void handleClientRequest(User user, ISFSObject isfso) {
        try{
            //khoatd
            DeleteLevelRequest request = new DeleteLevelRequest();
