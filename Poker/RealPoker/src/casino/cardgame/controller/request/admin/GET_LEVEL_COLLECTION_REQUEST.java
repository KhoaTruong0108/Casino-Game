...
import casino.cardgame.message.request.admin.GetLevelCollectionRequest;
 ...
 */
public class GET_LEVEL_COLLECTION_REQUEST extends BaseClientRequestHandler{

    @Override
    public void handleClientRequest(User user, ISFSObject isfso) {
        try{
            //khoatd
            GetLevelCollectionRequest request = new GetLevelCollectionRequest();
