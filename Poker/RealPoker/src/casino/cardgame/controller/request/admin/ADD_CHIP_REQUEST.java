...
import casino.cardgame.message.request.admin.AddChipForUserRequest;
 ...
 */
public class ADD_CHIP_REQUEST extends BaseClientRequestHandler{

    @Override
    public void handleClientRequest(User user, ISFSObject isfso) {
        try{
            //khoatd
            AddChipForUserRequest request = new AddChipForUserRequest();
