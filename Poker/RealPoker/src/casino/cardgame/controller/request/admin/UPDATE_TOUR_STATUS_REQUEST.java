...
import casino.cardgame.message.request.admin.UpdateTourStatusRequest;
 ...
 */
public class UPDATE_TOUR_STATUS_REQUEST extends BaseClientRequestHandler{

    @Override
    public void handleClientRequest(User user, ISFSObject isfso) {
        try{
            //khoatd
            UpdateTourStatusRequest request = new UpdateTourStatusRequest();
