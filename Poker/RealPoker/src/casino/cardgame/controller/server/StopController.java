...
public class StopController implements  IServerController {

    //Singleton Implement **************************************************
    //
    protected static StopController m_instance;
    protected StopController(){
        
    }
    public static StopController getInstance(){
        if(m_instance == null){
            m_instance = new StopController();
        }
        return m_instance;
    }
    //
