package Message.request.general {
	...
	public class GetTransactionByUserRequest extends SFSCustomRequest
	{
		public function GetTransactionByUserRequest()
		{
			super(GENERAL_REQUEST_NAME.GET_TRANS_BY_USER_REQ);
		}
