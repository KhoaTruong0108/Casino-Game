package Message.request.game.pokertexas {
	...
	public class SitOutRequest extends SFSCustomRequest
	{
		public static var IS_SIT_OUT: String = "is_sit_out";
		
		public function SitOutRequest()
		{
			super(POKER_REQUEST_NAME.SIT_OUT_REQ);
		}
