package Message.event.game.pokertexas
{
	...
	public class Notify_SitOn extends SFSGameEvent
	{
		...
		public function Notify_SitOn()
		{
			super(POKER_RESPONSE_NAME.SIT_ON_RES);
		}
		...
		override public function FromSFSEvent(sfse:SFSEvent):SFSGameEvent
		{
			if(sfse.type != SFSEvent.EXTENSION_RESPONSE &&
				sfse.params.cmd != POKER_RESPONSE_NAME.SIT_ON_RES){
				throw new Error("Can't parse from " + sfse.type + " to Notify_SitOn");			
			}
			var param : SFSObject = (sfse.params.params as SFSObject).getSFSObject(POKER_RESPONSE_NAME.SIT_ON_RES) as SFSObject;
			if(param == null){
				throw new Error("Notify_SitOn::FromSFSEvent Error");			
			}
		...
		{
			return POKER_RESPONSE_NAME.SIT_ON_RES;
		}
